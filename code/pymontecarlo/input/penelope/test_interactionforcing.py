...
# Local modules.
from pymontecarlo.input.penelope.interactionforcing import Collisions, InteractionForcing

# Globals and constants variables.
from pymontecarlo.input.penelope.interactionforcing import ELECTRON, PHOTON, POSITRON
