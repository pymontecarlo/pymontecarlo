...
# Local modules.
from pymontecarlo.program.mcxray.util.dist.debbuilder import MCXrayDebBuilder

# Globals and constants variables.

class bdist_deb_program(Command):

    description = 'Build deb for MC X-ray program'

    user_options = [('zip-file=', None,
                     "zip file containing the MC X-ray program and files "
                     ""),
                    ('dist-dir=', 'd',
    ...
    def run(self):
        builder = MCXrayDebBuilder(self.zip_file)
