...
# Local modules.
from pymontecarlo.program.winxray.util.dist.debbuilder import WinxrayDebBuilder
...
class bdist_deb_program(Command):
    ...
    user_options = [('zip-file=', None,
                     "zip file containing the WinX-Ray program and files "
                     ""),
                    ('dist-dir=', 'd',
    ...
    def run(self):
        builder = WinxrayDebBuilder(self.zip_file)
