...
# Local modules.
from pymontecarlo.program.monaco.util.dist.debbuilder import MonacoDebBuilder

# Globals and constants variables.

class bdist_deb_program(Command):

    description = 'Build deb for Monaco program'

    user_options = [('zip-file=', None,
                     "zip file containing the Monaco program and files "
                     ""),
                    ('dist-dir=', 'd',
    ...
    def run(self):
        builder = MonacoDebBuilder(self.zip_file)
