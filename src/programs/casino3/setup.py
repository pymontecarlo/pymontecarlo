...
setup(name="pyMonteCarlo-Casino3",
      version='0.1',
      ...
      entry_points={'pymontecarlo.program':
                        'casino3=pymontecarlo.program.casino3.config:program',
                    'pymontecarlo.program.cli':
                        'casino3=pymontecarlo.program.casino3.config_cli:cli',
                    'pymontecarlo.program.gui':
                        'casino3=pymontecarlo.program.casino3.config_gui:gui', },
