...
copyright = u'%i, Philippe T. Pinard and Hendrix Demers' % now.year
...
try:
    ...
    msg = "Error: pymontecarlo must be installed before building the documentation"
    sys.exit(msg)
...
latex_documents = [
  ('index', 'pymontecarlo.tex', u'pyMonteCarlo Documentation',
   u'Philippe T. Pinard and Hendrix Demers', 'manual'),
]
