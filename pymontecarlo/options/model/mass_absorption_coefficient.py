...
class MassAbsorptionCoefficientModel(ModelBase):
    ...
    HENKE1993 = (
        "Henke 1993",
        "B.L. Henke, E.M. Gullikson and J.C. Davis (1993). X-ray interactions: photoabsorption, scattering, transmission, and reflection at E=50-30000 eV, Z=1-92, Atomic Data and Nuclear Data Tables, 54, pp. 181-342",
    )
    BASTIN_HEIJLIGERS1989 = (
        "Bastin and Heijligers 1985 1988 1989",
        "as quoted in Scott, Love & Reed, Quantitative Electron-Probe Microanalysis, 2nd ed.",
    )
    HEINRICH_IXCOM11_DTSA = (
    ...
    DTSA_CITZAF = (
        "DTSA CitZAF",
        "DTSA at http://www.cstl.nist.gov/div837/Division/outputs/DTSA/DTSA.htm",
    )
    THINH_LEROUS1979 = (
        "Thinh and Leroux",
        "Thinh and Leroux (1979)",
    )
    LLNL1989 = (
        "LLNL Evaluated Photon Data Library",
        "Lawrence Livermore National Laboratory. (1989). Tables and graphs of photon-interaction cross sections from 10 eV to 100 GeV derived from the LLNL evaluated photon data library EPDL. Livermore, CA: Cullen, D., Chen, M., Hubbell, J., Perkins, S., Plechaty, E., Rathkopf, J., & Scofield, J..",
    )
