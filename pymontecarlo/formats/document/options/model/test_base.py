...
from pymontecarlo.formats.document.options.model.base import ModelDocumentHandler
from pymontecarlo.options.model.elastic_cross_section import ElasticCrossSectionModel

# Globals and constants variables.

class TestModelDocumentHandler(TestCase):

    def testconvert(self):
        handler = ModelDocumentHandler()
        model = ElasticCrossSectionModel.RUTHERFORD
        document = self.convert_documenthandler(handler, model)
