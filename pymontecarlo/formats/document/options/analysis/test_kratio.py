...
from pymontecarlo.formats.document.options.analysis.kratio import KRatioAnalysisDocumentHandler
from pymontecarlo.options.analysis.kratio import KRatioAnalysis

# Globals and constants variables.

class TestKRatioAnalysisDocumentHandler(TestCase):

    def testconvert(self):
        handler = KRatioAnalysisDocumentHandler()
