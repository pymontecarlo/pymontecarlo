...
@pytest.mark.parametrize('z,beam_energy_eV,minimum_energy_eV,expected',
    [(6, 20e3, 0.0, pyxray.xray_line(6, 'Ka1')),
     (13, 20e3, 0.0, pyxray.xray_line(13, 'Ll')),
     (13, 20e3, 1e3, pyxray.xray_line(13, 'Ka1'))
     ])
def test_lazylowestenergyxrayline(options, z, beam_energy_eV, minimum_energy_eV, expected):
